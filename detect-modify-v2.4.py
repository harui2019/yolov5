...
def parse_opt():
    ...
    parser.add_argument('--char_weights',nargs=1,type=str, default='./runs/train/.invoiceCharacter/weights/best.pt', help='best.pt for characteristic')
...
##    run_vars['weights'] = all_vars['char_weights'][0]
##    run_vars['exist_ok'] = False
...
##        print(run_vars)
    ## Run `detect.py`
    run(**{
        'weights':all_vars['char_weights'][0],
        'save_txt':True,
        'save_conf':True,
        'imgsz':512,
        'source':str(save_dir),
    ...
    print('-'*30 + '\n### Filter certified document')
    universal_cmd('python find_certified_doc.py --path1 ' + str(save_dir.stem) +
                  ' --path2 ' + str(run_vars['name']))
    print("#"*20)
